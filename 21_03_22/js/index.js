...
// const renderAdressHero = (value = "") => {
//     const display = addressHero.filter((e) =>
//         e.toLocaleLowerCase().includes(value.toLocaleLowerCase())
//     );
// }
...
//     buttonAdd.addEventListener("click", () => {
//         const input = usersAdd.value.lowerCase().includes(Element.toLocaleLowerCase)
